            ...
            <div className="p-4 border-b">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center space-x-2">
                        <div className={`h-2 w-2 rounded-full ${validationResult.isValid ? 'bg-green-500' :
                                        ...
                                        <div className="border-t bg-gray-50">
                                            <div className="p-2 space-y-1">
                                                {categoryIssues.map((issue, index) => (
                                                    <div
                                                        key={index}
                                                        className="bg-white rounded p-2 border text-xs flex justify-between"
                                                    >
                                                        ...
                                                        {issue.suggestedValue && issue.entity && (
                                                            <CheckCircle className="h-4 w-4 text-accent-foreground cursor-pointer mt-0.5 flex-shrink-0" onClick={() => onApplyFix(issue.entity,issue.row,issue.column,issue.suggestedValue)} />
                                                        )}
                                                    </div>
                                                ))}
                                            </div>
                                ...
                                <nav className="flex justify-between space-x-8 px-6">
                                    <div className='flex space-x-4'>
                                        {(['clients', 'workers', 'tasks'] as const).map((tab) => (
                                            <button
                                                ...
                                                className={`flex items-center space-x-2 py-4 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === tab
                                    ...
                                    <div className="flex items-center space-x-3">
                                        <button
                                            ...
                                            className="inline-flex items-center p-2 border shadow-lg text-sm font-medium rounded-md text-foreground bg-secondary hover:bg-accent hover:text-accent-foreground"
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`inline-flex items-center p-2 border border-transparent text-sm font-medium rounded-md text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 ${validationResult?.isValid
